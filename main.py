...
#LOCAL
from schedule import WatchCalendarUpdates
...
##place components in grid
btnStatusSelection2.grid(row=1,column=0)
lblDirectories.grid(row=1,column=1,padx=60)
lbxDirectories.grid(row=2,column=1,padx=60)
selectDirectory.grid(row=3,column=1,padx=60, pady=20)
btnAddDirectory.grid(row=3,column=1,padx=60, pady=20)
